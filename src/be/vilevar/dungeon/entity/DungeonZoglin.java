...
public class DungeonZoglin extends EntityZoglin implements IDungeonEntity {

	protected CraftEntity bukkitEntity;
	protected Hall hall;
	
	public DungeonZoglin(DungeonEntityTypes<EntityZoglin, ? extends DungeonZoglin> var0, World var1) {
	...
	public CraftEntity getBukkitEntity() {
		if (this.bukkitEntity == null) {
			this.setBukkitEntity(new CraftZoglin(this.world.getServer(), this));
		}
