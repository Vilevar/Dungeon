...
public class DungeonWitch extends EntityWitch implements IDungeonEntity {

	protected CraftEntity bukkitEntity;
	protected Hall hall;
	
	public DungeonWitch(DungeonEntityTypes<EntityWitch, ? extends DungeonWitch> entitytypes, World world) {
	...
	public CraftEntity getBukkitEntity() {
		if (this.bukkitEntity == null) {
			this.setBukkitEntity(new CraftWitch(this.world.getServer(), this));
		}
