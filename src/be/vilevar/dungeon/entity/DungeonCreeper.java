...
public class DungeonCreeper extends EntityCreeper implements IDungeonEntity {

	protected CraftEntity bukkitEntity;
	protected Hall hall;
	
	public DungeonCreeper(EntityTypes<? extends DungeonCreeper> entitytypes, World world) {
	...
	public CraftEntity getBukkitEntity() {
		if (this.bukkitEntity == null) {
			this.setBukkitEntity(new CraftCreeper(this.world.getServer(), this));
		}
