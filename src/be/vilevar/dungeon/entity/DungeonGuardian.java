...
public class DungeonGuardian extends EntityGuardian implements IDungeonEntity {

	protected CraftEntity bukkitEntity;
	protected Hall hall;
	
	public DungeonGuardian(DungeonEntityTypes<EntityGuardian, ? extends DungeonGuardian> var0, World var1) {
	...
	public CraftEntity getBukkitEntity() {
		if (this.bukkitEntity == null) {
			this.setBukkitEntity(new CraftGuardian(this.world.getServer(), this));
		}
